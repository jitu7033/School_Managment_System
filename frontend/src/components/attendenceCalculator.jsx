export const calculateSubjectAttendancePercentage = (presentCount , totalSession) =>{
    if(totalSession === 0 || presentCount === 0){
        return 0;
    }
    const percentage = (presentCount / totalSession) *100;
