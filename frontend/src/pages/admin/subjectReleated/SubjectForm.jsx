...
import { Button, TextField, Grid, Box, Typography, CircularProgress, filledInputClasses } from "@mui/material";
...
const SubjectForm = () => {
    ...
    const [subjects,setSubjects] =  useState([{subName : "",subCode : "", session : ""}]);
    ...
    const handleSessionsChange = (index) => (event) =>{
        const newSubjects = [...subjects];
        newSubjects[index].session = event.target.value;
        setSubjects(newSubjects);
    }
    ...
    const handleRemoveSubject = (index) =>{
        const newSubjects = [...subjects];
        newSubjects[index].splice(index,1);
        setSubjects(newSubjects);
    }
